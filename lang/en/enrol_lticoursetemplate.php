...
$string['endpointltiversionnotice'] = 'The tool endpoints below are for manual LTI 1.3 setup only. For earlier versions (1.1/2.0), details for consumers can be found on the \'Published as LTI Course Template tools\' page, accessible via course navigation.';
...
$string['lti:config'] = 'Configure \'Publish as LTI Course Template tool\' instances';
...
$string['privacy:metadata:enrol_ct_users'] = 'The list of users enrolled via an LTI provider';
$string['privacy:metadata:enrol_ct_users:userid'] = 'The ID of the user';
$string['privacy:metadata:enrol_ct_users:lastgrade'] = 'The last grade the user was recorded of having';
$string['privacy:metadata:enrol_ct_users:lastaccess'] = 'The time when the user last accessed the course';
$string['privacy:metadata:enrol_ct_users:timecreated'] = 'The time when the user was enrolled';
...
$string['registrationurlinfomessage'] = 'If the platform supports dynamic registration, use the registration URL below. For further information on dynamic registration, see the documentation for original <a href="{$a}">Publish as LTI tool</a>.';
...
$string['tasksyncgrades'] = 'Publish as LTI Course Template grade sync';
$string['tasksyncmembers'] = 'Publish as LTI Course Template users sync';
...
$string['invalidplatform'] = 'The platform name has not been set';
$string['invalidshortname'] = 'Course shortname (label) has not been set';
