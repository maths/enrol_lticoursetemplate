...
if (!\enrol_lticoursetemplate\helper::verify_cartridge_token($toolid, $token)) {
...
if (!is_enabled_auth('lti')) {
...
} else if (!enrol_is_enabled('lticoursetemplate')) {
    ...
    echo \enrol_lticoursetemplate\helper::create_cartridge($toolid);
}
