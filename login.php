...
// - enrol/lticoursetemplate/launch.php endpoint (for regular resource link launches) or
// - enrol/lticoursetemplate/launch_deeplink.php endpoint (for deep linking launches)
...
$validuris = [
    (new moodle_url('/enrol/lticoursetemplate/launch.php'))->out(false), // Resource link launches.
    (new moodle_url('/enrol/lticoursetemplate/launch_deeplink.php'))->out(false) // Deep linking launches.
];
