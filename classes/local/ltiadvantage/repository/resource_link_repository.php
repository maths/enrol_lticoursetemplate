...
namespace enrol_lticoursetemplate\local\ltiadvantage\repository;
use enrol_lticoursetemplate\local\ltiadvantage\entity\deployment;
use enrol_lticoursetemplate\local\ltiadvantage\entity\resource_link;

/**
 * Class resource_link_repository.
 *
 * This class encapsulates persistence logic for \enrol_lticoursetemplate\local\entity\resource_link type objects.
 *
...
class resource_link_repository {
    ...
    private $table = 'enrol_ct_resource_link';

    /** @var string the name of the table to which user-entity mappings will have been persisted. */
    private $userresourcelinkmaptable = 'enrol_ct_user_res_link';
     ...
     *
     * @param int $resourceid the local id of the resource (enrol_ct_tools id)
     * @param int $userid the local id of the enrol_lticoursetemplate\local\ltiadvantage\user object
    ...
    public function find_by_resource_and_user(int $resourceid, int $userid): array {
        ...
        $sql = "SELECT r.id, r.resourcelinkid, r.resourceid, r.ltideploymentid, r.lticontextid, r.lineitemsservice,
                  ...
                  FROM {enrol_ct_resource_link} r
                  JOIN {enrol_ct_user_res_link} ur
    ...
    public function delete(int $id) {
        global $DB;
        // First remove all enrol_ct_user_res_link mappings.
