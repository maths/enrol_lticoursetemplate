...
class lticonnection_launched extends \core\event\base
{
    ...
    {
        return "Valid LTI connection has been made: oauth_consumer_key: '{$this->other['oauth_consumer_key']}', context_id: '{$this->other['context_id']}', context_title: '{$this->other['context_title']}', user_id: '{$this->other['user_id']}', lis_person_name_given: '{$this->other['lis_person_name_given']}', lis_person_name_family: '{$this->other['lis_person_name_family']}', lis_email: '{$this->other['lis_email']}' ";
    }
