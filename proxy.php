...
$url = new moodle_url('/enrol/lticoursetemplate/tp.php');
$PAGE->set_url($url);
$PAGE->set_pagelayout('popup');
$PAGE->set_title(get_string('registration', 'enrol_lticoursetemplate'));
...
if (!\enrol_lticoursetemplate\helper::verify_proxy_token($toolid, $token)) {
    throw new \moodle_exception('incorrecttoken', 'enrol_lticoursetemplate');
}
$tool = \enrol_lticoursetemplate\helper::get_lti_tool($toolid);
