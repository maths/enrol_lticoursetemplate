...
if (is_null($draftreg) || $draftreg->is_complete()) {
    throw new moodle_exception('invalidexpiredregistrationurl', 'enrol_lticoursetemplate');
}
...
if (json_last_error() !== JSON_ERROR_NONE) {
    throw new moodle_exception('ltiadvdynregerror:invalidopenidconfigjson', 'enrol_lticoursetemplate');
}
...
$regrequest = (object) [
    ...
    'initiate_login_uri' => $CFG->wwwroot . '/enrol/lticoursetemplate/login.php?id=' . $draftreg->get_uniqueid(),
    'redirect_uris' => [
        $CFG->wwwroot . '/enrol/lticoursetemplate/launch.php',
        $CFG->wwwroot . '/enrol/lticoursetemplate/launch_deeplink.php',
    ],
     // TODO: Consider whether to support client_name#ja syntax for multi language support - see MDL-73109.
    'client_name' => get_string('moodle', 'enrol_lticoursetemplate'),
    'jwks_uri' => $CFG->wwwroot . '/enrol/lticoursetemplate/jwks.php',
    'logo_uri' => $OUTPUT->image_url('moodlelogo')->out(false),
    'token_endpoint_auth_method' => 'private_key_jwt',
    'https://purl.imsglobal.org/spec/lti-tool-configuration' => [
        'domain' => $parsed['host'],
        'target_link_uri' => $CFG->wwwroot . '/enrol/lticoursetemplate/launch.php',
        'custom_parameters' => [],
        'scopes' => [
        ...
        'messages' => [
            (object) [
                ...
                'allowLearner' => false,
                'target_link_uri' => $CFG->wwwroot . '/enrol/lticoursetemplate/launch_deeplink.php',
                 // TODO: Consider whether to support label#ja syntax for multi language support - see MDL-73109.
                'label' => get_string('registrationdeeplinklabel', 'enrol_lticoursetemplate', $sitefullname),
                'placements' => [
                    "ContentArea"
                ],
            ],
            (object) [
                ...
                'target_link_uri' => $CFG->wwwroot . '/enrol/lticoursetemplate/launch.php',
                // TODO: Consider whether to support label#ja syntax for multi language support - see MDL-73109.
                'label' => get_string('registrationresourcelinklabel', 'enrol_lticoursetemplate', $sitefullname),
                'placements' => [
                    "ContentArea"
                ],
            ],
...
if ($regresponse) {
    ...
    if ($regresponse->client_id) {
        ...
        if ($appregrepo->find_by_platform($openidconfig->issuer, $regresponse->client_id)) {
            throw new moodle_exception('existingregistrationerror', 'enrol_lticoursetemplate');
        }
