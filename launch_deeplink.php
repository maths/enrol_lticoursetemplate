...
$auth->complete_login(
    ...
    new moodle_url('/enrol/lticoursetemplate/launch_deeplink.php', ['launchid' => $messagelaunch->getLaunchId()]),
...
$url = new moodle_url('/enrol/lticoursetemplate/launch_deeplink.php');
$PAGE->set_url($url);
