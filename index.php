...
$pageurl = new moodle_url('/enrol/lticoursetemplate/index.php', array('courseid' => $courseid));
...
if (\enrol_lticoursetemplate\helper::count_lti_tools(array('courseid' => $courseid)) > 0) {
...
if ($ltiplugin->can_add_instance($course->id) AND
        \enrol_lticoursetemplate\helper::count_lti_tools(array('courseid' => $courseid)) <= 0) {
